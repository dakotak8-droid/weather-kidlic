    ...
    if (lang === "es") {
      if (isRainy) {
        ...
        if (isNY) {
          ...
          story = `Una llovizna clásica londinense caía afuera, dejando las calles húmedas y tranquilas. El sol salió a las ${sunrise} detrás de nubes pesadas con una temperatura de ${tempC}°C (${tempF}°F). Mientras la ciudad seguía con su rutina húmeda habitual, nuestro mundo se detuvo dentro de esa habitación de hospital. Te sostuvimos cerca, escuchando tus pequeños murmullos de recién nacido, con la certeza de que nunca habíamos sido tan felices.`;
        } else if (isToronto) {
          ...
          story = `La mañana en que naciste en ${city} fue húmeda y lluviosa, frente a un termómetro que marcaba unos templados ${tempC}°C (${tempF}°F) y un viento de ${windKn} km/h (${windMph} mph). Pero adentro estábamos en nuestro propio mundo de calma. Sostener tu pequeño cuerpo por primera vez nos hizo olvidar la lluvia de afuera. El día húmedo en ${city} quedó grabado para siempre como el inicio de nuestra familia.`;
        }
      ...
      if (isSnowy) {
        ...
        if (isNY) {
          ...
          story = `Una nieve fresca cubría por completo las calles históricas de Varsovia y la escarcha bordeaba el río Vístula. El sol asomó tras nubes frías a las ${sunrise} con una temperatura gélida de ${tempC}°C (${tempF}°F). Adentro, nuestra atención estaba puesta solo en ti. Escuchar tus primeros murmullos y sostenerte contra nuestro pecho nos dio todo el abrigo que necesitábamos. Varsovia estaba silenciosa bajo el invierno polaco, pero nuestros corazones estaban llenos de alegría.`;
        } else {
          story = `Una capa de nieve limpia cubría ${city} la mañana en que naciste, con una temperatura de ${tempC}°C (${tempF}°F) y un viento que soplaba la nieve afuera a ${windKn} km/h (${windMph} mph). Pero nuestra habitación del hospital era un refugio cálido y en paz. Al acunarte y darte un beso en la frente, sentimos una inmensa tranquilidad. El día nevado en ${city} será siempre el recuerdo más cálido de nuestras vidas.`;
        }
      ...
      if (isSunny) {
        ...
        if (isNY) {
          ...
          story = `Varsovia estaba iluminada por un sol brillante y despejado el día en que naciste. El sol de la mañana salió a las ${sunrise} sobre los edificios históricos del centro y brillaba en el río Vístula a unos agradables ${tempC}°C (${tempF}°F). En la habitación del hospital todo era paz y silencio mientras te abrazábamos por primera vez. Esa mañana luminosa en Varsovia siempre nos recordará el día en que por fin fuimos una familia.`;
        } else {
          story = `Un día despejado y lleno de sol nos recibió en ${city} cuando naciste, con cielos azules y una suave brisa soplando a ${windKn} km/h (${windMph} mph). La temperatura subió a unos agradables ${tempC}°C (${tempF}°F), haciendo que afuera fuera un día hermoso. Pero la mejor parte, por mucho, fue tenerte entre nuestros brazos por primera vez. El sol brillante de ${city} hizo que todo se sintiera aún más especial al darte la bienvenida a nuestra familia.`;
        }
      ...
      if (isNY) {
        ...
        story = `Un cielo cubierto y pacífico cobijaba las orillas del río Vístula y las viejas murallas de Varsovia la mañana en que naciste. El sol salió tras las nubes grises a las ${sunrise} con una brisa muy suave. Estábamos demasiado ocupados abrazándote por primera vez como para pensar en el clima. Sostener de pronto tu cuerpo ligero desató una calidez profunda en nuestro pecho que erradicó toda penumbra exterior.`;
      } else {
        story = `Un cielo gris y tranquilo cubría ${city} el día en que naciste, con una suave brisa soplando a ${windKn} km/h (${windMph} mph) y una temperatura agradable de ${tempC}°C (${tempF}°F). Afuera el día transcurría despacio y en paz, mientras que adentro vivíamos el momento más emocionante de nuestras vidas. Cuando te estrechamos por primera vez contra nuestro pecho, sentimos un profundo alivio y felicidad. Ese día nublado en ${city} es para siempre nuestro recuerdo preferido.`;
      }
