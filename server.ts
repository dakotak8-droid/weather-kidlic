...
Create a soft, highly atmospheric reminiscence in ${language} documenting the look, draft, light, and sensory feelings of the city environment of ${city}, ${country} (${region || "None"}) on ${birthDate}.
