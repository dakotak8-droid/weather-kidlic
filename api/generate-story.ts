...
function getOfflineBackupStory(params: {
  ...
  if (params.lang === "es") {
    ...
    if (isRainy) {
      ...
      quotes = [
        "Mientras la nieve cubría la ciudad, el silence blanco envolvía las calles.",
      ...
      quotes = [
        ...
        "El pesado cielo plateado cubrió con un silence protector los barrios históricos.",
